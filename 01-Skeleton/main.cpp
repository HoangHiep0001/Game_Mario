...
int numberbrick = 1 + SCREEN_WIDTH / BRICK_XY;
CBrick** number_brick = new CBrick*[numberbrick];
...
void LoadResources()
{
	...
	{
		number_brick[i] = new CBrick(BRICK_X+i* BRICK_XY, BRICK_Y, texBrick);
